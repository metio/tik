---
type: index
title: tik knowledge bundle
---

# tik knowledge bundle

An [Open Knowledge Format](https://github.com/GoogleCloudPlatform/knowledge-catalog)
(OKF v0.1) bundle. Concepts, decisions, and runbooks for tik — readable by
humans, navigable by agents. Guard `:hint`s in process definitions link here.

## Decisions

- [decisions/0001-event-log-acceptance-test](decisions/0001-event-log-acceptance-test.md)
- [decisions/0002-pinned-process-versions](decisions/0002-pinned-process-versions.md)
- [decisions/0003-conflicts-block](decisions/0003-conflicts-block.md)
- [decisions/0004-mandatory-parents](decisions/0004-mandatory-parents.md)
...
- [concepts/guards](concepts/guards.md)
- [concepts/witness](concepts/witness.md)
